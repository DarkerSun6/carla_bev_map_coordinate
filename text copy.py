...
def create_grid_on_image(image_path, grid_interval_x,grid_interval_y,add_x,add_y, output_path):
    try:
        # 加载图像
...
if __name__ == "__main__":
    ...
    grid_interval_x = 79 
    grid_interval_y = 78
    create_grid_on_image(image_path, grid_interval_x,grid_interval_y,add_x,add_y, output_path)